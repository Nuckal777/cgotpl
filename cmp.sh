...
testcase '{{ define "g" }}a{{ end }}{{ template "g" . }}b' 'null'
testcase '{{ define `h` }}a{{ end }}{{ template `h` . }}b' 'null'
testcase '{{ define .f }}a{{ end }}{{ template "g" . }}b' '{"f": "g"}'
testcase '{{ define "g" }}a{{ end }}{{ template .f . }}b' '{"f": "g"}'
testcase '{{ define "g" }}a{{ end }}{{ template 7 . }}b' 'null'
testcase '{{ define 7 }}a{{ end }}{{ template 7 . }}b' 'null'
testcase '{{ $var := "def" }}{{ define $var }}a{{ end }}{{ template $var . }}b' 'null'
testcase '{{ template "non-existent" . }}b' 'null'
testcase '{{ $var := 7}}{{ define "a" }}{{ $var }}{{ end }}{{ template "a" . }}' 'null'
testcase '{{ define "g" }}{{ $lol := 3 }}{{ end }}{{ template "g" . }}{{ $lol }}' 'null'
testcase '{{ define "1" }}{{ define "2" }}a{{ end }}{{ end }}{{ template "1" . }}' 'null'
