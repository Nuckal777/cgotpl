...
testcase '{{ range1 }} {{.}} {{- end}}' 'null'
testcase '{{ range(1) }} {{.}} {{- end}}' 'null'
...
testcase '{{ true|not|not|not}}' 'null'
...
testcase '{{ print . }}' 'null'
testcase '{{ print 4 . 5 . }}' 'null'
testcase '{{ print . }}' '654'
testcase '{{ print . }}' '"cba"'
testcase '{{ print . }}' '[9,8,7]'
testcase '{{ print . }}' '{"h": "i"}'
testcase '{{ print "a" 5 }}' '{"h": "i"}'
testcase '{{ print 5 "a" }}' '{"h": "i"}'
testcase '{{ print "z" "a" }}' '{"h": "i"}'
testcase '{{ print "a" .x . true false 7 }}' '{"x": [1,2]}'
testcase '{{ print nil nil nil }}' 'null'
testcase '{{ print }}' 'null'
testcase '{{ println . }}' '789'
testcase '{{ println }}' 'null'
testcase '{{ $s := println 924 }} {{ $s }}' 'null'
testcase '{{ print $ := 7 }}' 'null'
testcase '{{ print $:= 7 }}' 'null'
testcase '{{ print $:=7 }}' 'null'
testcase '{{ print $ :=7 }}' 'null'
testcase '{{ $a := $b := 44 }}{{ $a }}{{ $b }}' 'null'
testcase '{{ print ($:= ($:= ($ | print ($ := 7)))) }}' 'null'
testcase '{{ index }}' 'null'
...
testcase '{{ eq 2 2 }}' 'null'
testcase '{{ eq 2 4 2 }}' 'null'
testcase '{{ eq 2 2 4 }}' 'null'
testcase '{{ eq 2 "a" }}' 'null'
testcase '{{ eq "a" "a" }}' 'null'
testcase '{{ eq true true }}' 'null'
testcase '{{ eq true false }}' 'null'
testcase '{{ eq true nil }}' 'null'
testcase '{{ eq 7 nil }}' 'null'
testcase '{{ eq nil nil }}' 'null'
testcase '{{ eq (index . 0) (index . 1) }}' '[[2,1],[2,1]]'
testcase '{{ eq (index . 0) (index . 1) }}' '[[2,1],[2,3]]'
...
testcase '{{ ne 4 }}' 'null'
testcase '{{ ne }}' 'null'
testcase '{{ gt 1 false }}' 'null'
testcase '{{ gt 1 "f" }}' 'null'
testcase '{{ gt 3 2 }}' 'null'
testcase '{{ gt 2 2 }}' 'null'
testcase '{{ gt 1 2 }}' 'null'
testcase '{{ ge 3 2 }}' 'null'
testcase '{{ ge 2 2 }}' 'null'
testcase '{{ ge 1 2 }}' 'null'
testcase '{{ le 3 2 }}' 'null'
testcase '{{ le 2 2 }}' 'null'
testcase '{{ le 1 2 }}' 'null'
testcase '{{ lt 3 2 }}' 'null'
testcase '{{ lt 2 2 }}' 'null'
testcase '{{ lt 1 2 }}' 'null'
testcase '{{ gt "c" "b" }}' 'null'
testcase '{{ gt "b" "b" }}' 'null'
testcase '{{ gt "a" "b" }}' 'null'
testcase '{{ ge "c" "b" }}' 'null'
testcase '{{ ge "b" "b" }}' 'null'
testcase '{{ ge "a" "b" }}' 'null'
testcase '{{ le "c" "b" }}' 'null'
testcase '{{ le "b" "b" }}' 'null'
testcase '{{ le "a" "b" }}' 'null'
testcase '{{ lt "c" "b" }}' 'null'
testcase '{{ lt "b" "b" }}' 'null'
testcase '{{ lt "a" "b" }}' 'null'
